...
export const NavbarPastcasting = () => {
  ...
  const navigation = [
    {
      name: "Pastcasting",
      href: "/pastcasting",
      current: pathname === "/pastcasting",
    },
    {
      name: "Multiplayer",
      href: "/pastcasting/multiplayer",
      current: pathname.startsWith("/pastcasting/multiplayer"),
    },
    {
      name: "Leaderboard",
      href: "/pastcasting/leaderboard",
      current: pathname === "/pastcasting/leaderboard",
    },
    {
      name: "Charts",
      href: "/pastcasting/charts",
      current: pathname === "/pastcasting/charts",
    },
    {
      name: "FAQ",
      href: "/pastcasting/faq",
      current: pathname === "/pastcasting/faq",
    },
    {
      name: "Discord",
